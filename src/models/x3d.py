...
class ResNet(nn.Module):
    ...
    def __init__(self,
        ...
        #self.bn1 = SubBatchNorm3d(num_splits=self.base_bn_splits, num_features=self.in_planes, affine=True)    
        ...
        self.conv5 = nn.Conv3d(block_inplanes[3][1],
                               ...
                               padding=(0, 0, 0),
                               bias=False)
        #self.bn5 = SubBatchNorm3d(num_splits=self.base_bn_splits, num_features=block_inplanes[3][0], affine=True) 
